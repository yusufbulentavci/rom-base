package com.bilgidoku.rom.base.run;
...
import com.bilgidoku.rom.base.run.Threads.ThreadUse.ThreadRunImpl;
import com.bilgidoku.rom.base.run.timer.EveryDay;
import com.bilgidoku.rom.base.run.timer.EveryHalfHour;
import com.bilgidoku.rom.base.run.timer.EveryHour;
import com.bilgidoku.rom.base.run.timer.EveryMinute;
import com.bilgidoku.rom.base.run.timer.EveryMonth;
import com.bilgidoku.rom.base.run.timer.EveryQuaterHour;
import com.bilgidoku.rom.base.run.timer.EverySixHours;
import com.bilgidoku.rom.base.run.timer.EveryTwelveHours;
import com.bilgidoku.rom.base.run.timer.EveryTwoHours;
import com.bilgidoku.rom.base.run.timer.EveryYear;
import com.bilgidoku.rom.base.run.timer.Timer;
import com.bilgidoku.rom.base.run.timer.ZamanlayiciYardim;
...
public class KosuGorevlisi extends GorevliDir implements ZamanlayiciYardim {
	...
	private static KosuGorevlisi tek;
	
	@Override
	protected void bindDependency() {
	}
	public static KosuGorevlisi bind(Gorevli binder) {
		if (tek == null) {
	...
	public Future<?> execControlled(Runnable run) {
